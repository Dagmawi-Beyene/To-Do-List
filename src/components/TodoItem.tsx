...
export default ({
	...
	return (
		<li>
			{editing ? (
				<>
					<input className="edit-item" ref={inputText} defaultValue={text} />
					<div>
						<span
							className="icon"
							role="presentation"
							onClick={() => acceptEdit(id)}
						>
				...
				<>
					<div className="check-item-container">
						<div
							onClick={() => toggleItem(id, !complete)}
							role="presentation"
